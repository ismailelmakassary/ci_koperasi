...
<body style="padding-top: 56px;">
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4 py-3">
          <h1>Input Data Koperasi</h1><br>        
      <div class="row text-center">
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
        <div class="card-body">
          <a href="#" class="btn btn-info">Transaksi</a>
        </div>
      </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
        <div class="card-body">
          <a href="#" class="btn btn-info">Investasi</a>
        </div>
      </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
        <div class="card-body">
          <a href="#" class="btn btn-info">Peminjaman</a>
        </div>
      </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
        <div class="card-body">
          <a href="<?= base_url()?>belanja" class="btn btn-info">Belanja</a>
        </div>
      </div>
        </div>
    </div>
    ...
    <!-- Jumbotron Header -->
    <header class="jumbotron my-4 py-3">
          <h1>Daftar Riwayat Koperasi</h1><br>
    ...
    <div class="row text-center">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
            <div class="card-body">
              <a href="#" class="btn btn-info">Anggota</a>
            </div>
          </div>
        </div>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Pesantren Teknologi Informasi dan Komunikasi <?= date('Y'); ?></p>
    </div>
    <!-- /.container -->
  </footer>
